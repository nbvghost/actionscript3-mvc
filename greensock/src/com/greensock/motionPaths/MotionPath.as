 ...
 */	
	public class MotionPath extends Shape {
		 ...
		 * Log.out(myPath.progress); //Log.outs "0.1"<br />
		 * Log.out(myPath.rawProgress); //Log.outs "2.1"<br /><br /></code>
		 * 
		 ...
		 * property in Flash where setting it to 270 works fine but when you Log.out() the rotation value it will report 
