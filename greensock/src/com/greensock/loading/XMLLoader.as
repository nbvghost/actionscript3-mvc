...
function completeHandler(event:LoaderEvent):void {
	...
	Log.out("first link url: " + xml.links[0].link[0].&#64;url); //Log.outs "first link url: http://www.greensock.com"
}
</listing>
 * 
 ...
 * @example Example AS3 code:<listing version="3.0">
 ...
 function completeHandler(event:LoaderEvent):void {
 	Log.out("load complete. XML content: " + LoaderMax.getContent("xmlDoc"));
