 ...
 */	
	public class LoaderCore extends EventDispatcher {
		...
		/** A name that you use to identify the loader instance. This name can be fed to the <code>getLoader()</code> or <code>getContent()</code> methods or Log.outd at any time. Each loader's name should be unique. If you don't define one, a unique name will be created automatically, like "loader21". **/
