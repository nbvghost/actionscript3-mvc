...
public class AssetsData implements IAssetsData {
	...
	public function get asssetAllCompleteFunc():Function {
		return _asssetAllComplete;
	}
	
	public function set asssetAllCompleteFunc(value:Function):void {
		_asssetAllComplete = value;
	}
