...
public class AwayStats extends Sprite {
     ...
     * can also click the average frame rate Log.out-out to reset just that one
     * value.
     *
    ...
    public function AwayStats() {
        ...
        if (_INSTANCE)
            Log.out('Creating several statistics windows in one project. Is this intentional?');
        _INSTANCE = this;
