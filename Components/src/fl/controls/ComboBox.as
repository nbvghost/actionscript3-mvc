...
package fl.controls {
	...
	public class ComboBox extends UIComponent implements IFocusManagerComponent {
		...
		override protected function configUI():void {
			...
			addChild(inputField);
			var ite:TextFormat = new TextFormat();
			ite.color =0xffffff;
			ite.size = 12;
			inputField.setStyle("textFormat",ite);
			//trace(inputField.getStyle("textFormat"));
			//inputField.y = inputField.y-1;
			
			//inputField.setStyle("size",20);
