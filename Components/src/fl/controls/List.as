...
package fl.controls {
	...
	public class List extends SelectableList implements IFocusManagerComponent{
		...
		override protected function drawList():void {
			...
			background.height = rect.height+10;
			//listBg.width =contentScrollRect.width+_verticalScrollBar.width+20;
			//listBg.height =  contentScrollRect.height;
			//listBg.filters=[new DropShadowFilter(1, 60, 0x000000, 0.3, 10, 10, 1,BitmapFilterQuality.LOW, false, false)];
